...
package computingtaxesibrahimmohamed;

import java.util.Scanner;

public class ComputingTaxesIbrahimMohamed
{
    ...
    public static void main(String[] args)
    {
        ...
        if (status == 0)
        {
            // Computes tax for single filers 
            if (income <= 8350)
            {
                tax = income * 0.10;
        ...
        //computes tax for married filed jointly or qualifying widow(er)
        {
            if (income <= 16700)
            {
                tax = income * 0.10;
        ...
        //computes tax for married seperately
        {
            if (income <= 8350)
            {
                tax = income * 0.10;
        ...
        //computes tax for head of household
        {
            if (income <= 11950)
            {
                tax = income * 0.10;
...
// Married jointly or qualifying widow(er) TEST
    // 15349.63         10%
    // 29474.38         15%
    // 98344.43         25%
    // 187384.57        28%
